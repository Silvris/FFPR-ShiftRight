...
namespace FFPR_ShiftRight
{
    public class Configuration
    {
        ...
        public ConfigEntry<WindowModes> configOne { get; set; }
        ...
        public Configuration(ConfigFile file)
        {
            ...
            configOne = file.Bind(new ConfigDefinition(Group, nameof(configOne)), WindowModes.ShiftRight, new ConfigDescription("The window mode to use upon game startup."));
        ...
        public WindowModes WindowMode => configOne.Value;
    }
}
